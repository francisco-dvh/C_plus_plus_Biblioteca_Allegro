...
int main (void)
/*desafio para por meu nome em cima da imagem,
após quatro segundo ela aparece em baixo da imagem!
*/
{
    int Lar_T= 800;
    int Alt_T= 400;
...
al_clear_to_color(Cor_fundo);
    ...
    al_draw_text(fonte, al_map_rgb(0,255,0),10,h+75+10,NULL, "FRANCISCO");
   al_draw_bitmap(foto, 10, 75, NULL);
   al_flip_display();
